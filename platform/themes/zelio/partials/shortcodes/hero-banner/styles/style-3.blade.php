<div id="about" class="hero-3 pe-lg-5 border-bottom pb-7">
    ...
    @if($shortcode->primary_button_text)
        <a href="{{ ($shortcode->primary_button_link ?: $shortcode->primary_button_url) }}" class="btn btn-secondary-3 me-2">
    ...
    @if($shortcode->secondary_button_text)
        <a href="{{ ($shortcode->secondary_button_link ?: $shortcode->secondary_button_url) }}" class="btn btn-outline-secondary-3 d-inline-flex align-items-center">
